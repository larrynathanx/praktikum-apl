...
int PartitionID(Kamera *data, int low, int high){
    string pivot = (data + high)-> ID_Kamera;
    int i = low - 1;
...
void QuickSortID(Kamera *data, int low, int high){
    if (low < high){
        ...
        int kiriLow = low;
        int kiriHigh = pivot - 1;
        int kananLow = pivot + 1;
        int kananHigh = high;
        ...
        switch(PilihMenu)
        {
            ...
            if (role_login == "admin")
            {
                ...
                { 
                    ...
                    cout << "5. Sortir Nama Kamera\n";
                    cout << "6. Sortir Harga Sewa Kamera\n";
                    cout << "7. Sortir ID Kamera\n";
                    cout << "8. Logout\n";
                    cout << "Pilih (1-8): ";
                    cin >> pilihan;
                    cin.ignore();
